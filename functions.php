...
function ayr_scripts() {
	...
	wp_enqueue_script( 'ayrUtils', get_template_directory_uri() . '/js/ayrUtils.js', array(), '1.0', true );

	wp_enqueue_script( 'ayr-script', get_template_directory_uri() . '/js/script.js', array('jquery', 'ayrUtils'), '1.0', true );
